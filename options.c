...
int option(SDL_Surface *fenetre, SDL_Surface *imagebg, SDL_Rect positionFond, int renvoi){
   SDL_Surface *texte1=NULL, *texte2=NULL, *texte3=NULL, *texte4=NULL;
    ...
    texte1 = TTF_RenderText_Blended(police, "OPTIONS", couleurNoire);
    texte2 = TTF_RenderText_Blended(police, "", couleurNoire);
    if(renvoi!=5) texte3 = TTF_RenderText_Blended(police, "REPRENDRE LA PARTIE", couleurNoire);
