...
int stats(SDL_Surface *fenetre, SDL_Surface *imagebg, SDL_Rect positionFond, TTF_Font *police, int renvoi){
    ...
    txt_Quit    = TTF_RenderText_Blended(police, "SAVE & QUIT", couleurNoire);
    ...
    positionRect_Quit.y = 300;

    positionRect_Menu.x = 200;
    positionRect_Menu.y = 400;
    ...
    positionTxt_Menu.x=positionRect_Menu.x+(Reclongueur/4);
